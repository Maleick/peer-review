...
4. **VERIFY (convergence check)** — Re-read the modified file. Generate a stable identity hash for each item: `sha256({file_path}:{concern_type}:{first_10_words})[:12]`. Use these hashes to track items across iterations:
